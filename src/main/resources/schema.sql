...
CREATE TABLE IF NOT EXISTS FRIENDSHIP_STATUS (
    	...
    	FRIENDSHIP_STATUS_NAME VARCHAR
    );

CREATE TABLE IF NOT EXISTS FRIENDSHIP (
    	FIRST_FRIEND_ID INTEGER NOT NULL PRIMARY KEY REFERENCES USERS(USER_ID),
    ...
    CREATE TABLE IF NOT EXISTS LIKES (
       ...
       CREATE INDEX IF NOT EXISTS FRIENDSHIP_INDEX ON FRIENDSHIP (FRIENDSHIP_STATUS_ID);
       ...
       CREATE UNIQUE INDEX IF NOT EXISTS FRIENDSHIP_ID_INDEX ON FRIENDSHIP_STATUS (FRIENDSHIP_STATUS_ID);
       CREATE UNIQUE INDEX IF NOT EXISTS FIRST_FRIEND_ID_INDEX ON FRIENDSHIP (FIRST_FRIEND_ID);
